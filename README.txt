...
"gm.special.edition.csv" (this is a special edition of the AUTOTYP grammatical.markers file, first produced in 2017 and now available at https://github.com/autotyp/)
"gm.langnames.csv" (this is the same as "gm.special.edition", but with the names of language and stock merged in for convenience)
